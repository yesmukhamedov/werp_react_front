...
export function frcolnSearchData(
    ...
    return function(dispatch) {
        ...
        doGet(`core/finance/reports/frcoln/searchByBranches`, {
            bukrs: a_bukrs,
...
export function frcolnFetchBranchData(
    ...
    return function(dispatch) {
        dispatch(modifyLoader(true));
        doGet(`core/finance/reports/frcoln/searchByBranch`, {
            bukrs: a_bukrs,
            branchId: a_branchId,
            waers: a_waers,
            year,
...
export function frcolnFetchCollectorData(
    ...
    return function(dispatch) {
        dispatch(modifyLoader(true));
        doGet(`core/finance/reports/frcoln/searchByCollector`, {
            bukrs: a_bukrs,
            branchId: a_branchId,
            waers: a_waers,
            year,
...
export function frcolnSaveData(a_bukrs, a_date, a_period) {
    ...
    return function(dispatch) {
        dispatch(modifyLoader(true));
        doPost(
            `core/finance/reports/frcoln/saveFrcolStatistics`,
            {},
            {
                bukrs: a_bukrs,
                year,
