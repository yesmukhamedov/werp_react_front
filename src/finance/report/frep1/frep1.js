...
class Frep1 extends Component {
    ...
    exportExcel() {
        ...
        excelDownload(
            'core/finance/reports/frep1/downloadExcel',
            'frep1.xls',
            'outputTable',
    ...
    searchFrep1() {
        ...
        if (errors === null || errors === undefined || errors.length === 0) {
            this.props.fetchDynamicFAGM('core/finance/reports/frep1/search', {
                ...this.state.searchTerm,
    ...
    render() {
        ...
        let t1r1c4 = {
            ...
            filterMethod: (filter, rows) =>
                matchSorter(rows, filter.value, {
                    keys: [
                        { threshold: rankings.CONTAINS, key: 'hkont1020Name' },
                    ],
                }),
            filterAll: true,
            width: 100,
