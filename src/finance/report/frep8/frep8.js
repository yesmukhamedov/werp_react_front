...
const Frep8 = props => {
    ...
    const searchFrep8 = () => {
        ...
        if (errors === null || errors === undefined || errors.length === 0) {
            ...
            props.fetchDynamicFAGM('core/finance/reports/frep8/search', {
                bukrs,
    ...
    const exportExcel = () => {
        ...
        excelDownload(
            'core/finance/reports/frep8/downloadExcel',
            'frep8Result.xls',
            'outputTable',
            outputTable,
            excelHeaders,
    ...
    let t1r1c2 = {
        ...
        Cell: obj => (
            <span>
                {obj.original.sn && <LinkToDmsc03 snNum={obj.original.sn} />}
            </span>
        ),
        width: 90,
    };
    let t1r1c3 = {
        ...
        Cell: obj => (
            <span>
                {obj.original.oldSn && (
                    <LinkToDmsc03 snNum={obj.original.oldSn} />
                )}
            </span>
        ),
        width: 90,
