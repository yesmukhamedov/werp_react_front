...
class Frep4 extends Component {
    ...
    searchFrep4() {
        ...
        if (errors === null || errors === undefined || errors.length === 0) {
            this.props.fetchDynamicFAGM('core/finance/reports/frep4/search', {
                ...this.state.searchTerm,
                        ...
                        outputTable.map((wa, idx) => {
                            return (
                                ...
                                >
                                    ...
                                    <Table.Cell>
                                        {moneyFormat(wa.dmbtr)}
                                    </Table.Cell>
                                    <Table.Cell>
                                        {moneyFormat(wa.wrbtr)}
                                    </Table.Cell>
                                    <Table.Cell>
                                        {wa.hkont !== null && (
                                            <Icon
    ...
    getDetail(branchId, hkont, waers) {
        this.props.modifyLoader(true);
        this.props.fetchDynamicFAGM('core/finance/reports/frep4/searchDetail', {
