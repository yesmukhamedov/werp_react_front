...
class Frep6 extends Component {
    ...
    exportExcel() {
        ...
        excelDownload(
            'core/finance/reports/frep6/downloadExcel',
            'frep6.xls',
            'outputTable',
    ...
    renderSearchTab() {
        ...
        const cashBankOptions = [
            ...
            {
                key: 1,
                text: formatMessage(messages.cashAccount),
                value: '1010',
            },
            {
                key: 2,
                text: formatMessage(messages.bankAccount),
                value: '1030',
            },
        ];
