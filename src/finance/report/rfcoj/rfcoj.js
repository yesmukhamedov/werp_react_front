...
class Rfcoj extends Component {
    ...
    searchRfcoj() {
        ...
        if (errors === null || errors === undefined || errors.length === 0) {
            this.props.fetchDynamicFAGM('core/finance/reports/rfcoj/search', {
                ...this.state.searchTerm,
    ...
    exportExcel() {
        ...
        excelDownload(
            'core/finance/reports/rfcoj/downloadExcel',
            'Rfcoj.xls',
            'outputTable',
            outputTableState,
            excelHeaders,
    ...
    render() {
        ...
        t1r1c4.Footer = (
            <span>
                <strong>
                    <font color={'green'}>
                        {totalIn
                            ? moneyFormat(new BigNumber(totalIn).toFixed(2))
                            : ''}
                    </font>
                </strong>
            </span>
            ...
            <span>
                <strong>
                    <font color={'red'}>
                        {totalOut > 0 ? '-' : ''}
                        {totalOut
                            ? moneyFormat(new BigNumber(totalOut).toFixed(2))
                            : ''}
                    </font>
                </strong>
            </span>
        ...
        let t1r1c9 = {
            ...
            Cell: obj => (
                <span>
                    {obj.original.snNum && (
                        <LinkToDmsc03 snNum={obj.original.snNum} />
                    )}
                </span>
            ),
            width: 90,
