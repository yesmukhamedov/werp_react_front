  ...
  render() {
    ...
    return (
      <Segment padded size="small">
        <StaffF4Modal
          open={this.state.staffF4ModalOpen}
          closeModal={bool => this.staffF4ModalOpenHanlder(bool)}
          onStaffSelect={item => this.props.onInputChange(item, 'lifnr')}
          trans="fcis"
          brnch={brnch}
            ...
            <Table.Row>
              <Table.Cell>
                <Dropdown
                  ...
                  selection
                  options={hkontOptions_h || []}
                  value={hkont_h}
                  onChange={(e, { value }) =>
                    this.props.onInputChange(value, 'hkont_h')
                  }
                />
              </Table.Cell>
              <Table.Cell>
                <Dropdown
                  ...
                  selection
                  options={hkontOptions_s || []}
                  value={hkont_s}
                  onChange={(e, { value }) =>
                    this.props.onInputChange(value, 'hkont_s')
                  }
                />
              </Table.Cell>
              <Table.Cell>
              ...
              <Table.Cell>
                <Input
                  ...
                  maxLength="18"
                  onChange={(e, { value }) =>
                    this.props.onInputChange(value, 'summa')
                  }
                />
              </Table.Cell>
            </Table.Row>
