...
import {clearfaBkpf, changefaBkpf, fetchIncomeHkontsByBukrs, fetchCashBankHkontsByBranch, saveFiSrcDocs} from '../../fa_action';
...
class Faci01 extends Component {
    ...
    onInputChange(value,stateFieldName){ 
      ...
      {
        let hkont_h = !this.state.withInvoice?this.state.hkont_h:'';
    ...
    validate(){
      ...
      if (withInvoice===true && (hkont_h===null || hkont_h===undefined || !hkont_h)) { errors.push(errorTable['12'+language]); }
      return errors;
    }
    ...
    render(){
      ...
      const {customerF4ModalOpen, withInvoice, amount, lifnrName, hkont_h, hkont_s}  = this.state;  
                                ...
                                <Table.Body>
                                    <Table.Row>
                                        ...
                                        <Table.Cell>
                                            ...
                                            value={hkont_h}  onChange={(e, { value }) => this.onInputChange(value,'hkont_h')} disabled={!withInvoice}/>  
                                        </Table.Cell>
                                    </Table.Row>                                    
                                </Table.Body>                     
                            </Table>
...
export default connect(mapStateToProps,{ f4FetchDepartmentList, f4FetchCurrencyList, modifyLoader,
  f4FetchExchangeRateNational, changefaBkpf, clearfaBkpf, fetchIncomeHkontsByBukrs, fetchCashBankHkontsByBranch,saveFiSrcDocs }) (injectIntl(Faci01));
