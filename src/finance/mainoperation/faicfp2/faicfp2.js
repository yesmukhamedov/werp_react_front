...
class Faicfp2 extends Component {
    ...
    componentDidMount() {
        ...
        this.props.fetchDynamicFAGM(
            'core/finance/mainoperation/fetchCitiesWithMainOffices',
            params,
        );
    ...
    onInputChange(value, stateFieldName, position) {
        if (position === null) {
            ...
            if (stateFieldName === 'waers') {
                ...
                stateFieldName === 'budat' ||
                stateFieldName === 'bldat'
            ) {
                ...
                this.props.fetchDynamicFAGM(
                    'core/finance/mainoperation/fetchCityBranchCashBanks',
                    params,
                );
                this.initializeBseg();
                this.initializeCashBanks();
            ...
            if (stateFieldName === 'summa') {
                ...
                //updating all rows amount
                if (position === 0 && value === 'S')
                    bseg[1][stateFieldName] = 'H';
                else if (position === 0 && value === 'H')
                    bseg[1][stateFieldName] = 'S';
                else if (position === 1 && value === 'S')
                    bseg[0][stateFieldName] = 'H';
                else if (position === 1 && value === 'H')
                    bseg[0][stateFieldName] = 'S';
            } else {
                waBseg[stateFieldName] = value;
            }
    ...
    validate() {
        ...
        if (
            ...
            errors.push(
                errorTable[`3${language}`] +
                    ' ' +
                    errorTable[`25${language}`] +
                    ' 1',
            );
        }
        if (
