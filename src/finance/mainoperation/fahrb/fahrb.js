...
class Fahrb extends Component {
  ...
  onInputChange(value, stateFieldName) {
    if (stateFieldName === 'dmbtr') {
      ...
      if (newVal !== undefined) {
        this.setState({
          payroll: { ...this.state.payroll, [stateFieldName]: newVal },
        });
      }
    } else {
      this.setState({
        ...
        {doubtfulDebtAccountList && (
          <Grid.Row>
            <Grid.Column mobile={16} tablet={16} computer={16}>
              <Segment>
                <Label color="orange" ribbon>
                  {formatMessage(messages.doubtfulDebtAccount)}
                </Label>
                <Table compact>
                  <Table.Body>
                    {doubtfulDebtAccountList.map((item, key) => (
                      <Table.Row key={key}>
                        <Table.Cell>
                          <Input value={item.waers} readOnly />
                        </Table.Cell>
  ...
  render() {
    ...
    const operationOptions = [
      { key: 1, text: formatMessage(messages.fahrb_op_pay_loan), value: '1' },
      {
        key: 2,
                ...
                <Table compact>
                  <Table.Body>
                    <Table.Row>
                      ...
                      <Table.Cell>
                        <Input value={bukrsName || ''} readOnly fluid />
                      </Table.Cell>
                    </Table.Row>
                    <Table.Row>
                      <Table.Cell>
                      ...
                      <Table.Cell>
                        <Input value={branchName || ''} readOnly fluid />
                      </Table.Cell>
                    </Table.Row>
                    <Table.Row>
                      <Table.Cell>
                      ...
                      <Table.Cell>
                        <Input value={staffName || ''} readOnly fluid />
                      </Table.Cell>
                    </Table.Row>
                    <Table.Row>
                      <Table.Cell>
                      ...
                      <Table.Cell>
                        <Dropdown
                          ...
                          value={operation}
                          onChange={(e, { value }) =>
                            this.onInputChange(value, 'operation')
                          }
                    ...
                    <Table.Row>
                      ...
                      <Table.Cell>
                        <Input
                          ...
                          fluid
                          onChange={(e, { value }) =>
                            this.onInputChange(value, 'dmbtr')
                          }
                        />
                      </Table.Cell>
                    </Table.Row>
