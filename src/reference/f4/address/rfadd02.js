...
const Rfadd02 = props => {
    ...
    const onSave = () => {
        ...
        if (errors === null || errors === undefined || errors.length === 0) {
            props.saveRfadd02(
                'core/reference/address/update_address',
                { address },
                { trans: 'RFADD02', customerId },
            ...
            <table>
                <tbody>
                    <tr>
                        ...
                        <td>
                            {customerName ? (
                                <span className="reqOneTxt">
                                    {customerName}
                                </span>
                            ) : (
                                <span className="reqTxt">
                                    {errorTable[`9${language}`]}
                                </span>
                            )}
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <select
                                ...
                                onChange={event =>
                                    onInputChange(event.target.value, 'stateId')
                                }
                                className="clickableItem"
                            >
                    ...
                    <tr>
                        ...
                        <td>
                            <select
                                ...
                                onChange={event =>
                                    onInputChange(event.target.value, 'cityId')
                                }
                                className="clickableItem"
                            >
                    ...
                    <tr>
                        ...
                        <td>
                            <select
                                value={address.regId}
                                onChange={event =>
                                    onInputChange(event.target.value, 'regId')
                                }
                                className="clickableItem"
                            >
                    ...
                    <tr>
                        <td>
                            {messages['microdistrict']}{' '}
                            <span className="reqOneTxt">*</span>
                        </td>
                        <td>
                            <input
                    ...
                    <tr>
                        ...
                        <td>
                            <input
                                ...
                                onChange={event =>
                                    onInputChange(event.target.value, 'village')
                                }
                                autoComplete="off"
                                maxLength="30"
                                size="25"
                    ...
                    <tr>
                        ...
                        <td>
                            <input
                                ...
                                onChange={event =>
                                    onInputChange(event.target.value, 'avenue')
                                }
                                autoComplete="off"
                                maxLength="30"
                                size="25"
                    ...
                    <tr>
                        ...
                        <td>
                            <input
                                ...
                                onChange={event =>
                                    onInputChange(event.target.value, 'street')
                                }
                                autoComplete="off"
                                maxLength="30"
                                size="25"
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input
                                ...
                                onChange={event =>
                                    onInputChange(event.target.value, 'ap_drob')
                                }
                                autoComplete="off"
                                maxLength="5"
                                size="3"
                    ...
                    <tr>
                        ...
                        <td>
                            <input
                                ...
                                onChange={event =>
                                    onInputChange(event.target.value, 'telDom')
                                }
                                size="25"
                                autoComplete="off"
                                maxLength="15"
                    ...
                    <tr>
                        ...
                        <td>
                            <input
                                ...
                                onChange={event =>
                                    onInputChange(event.target.value, 'telMob1')
                                }
                                size="20"
                                autoComplete="off"
                                maxLength="15"
                    ...
                    <tr>
                        ...
                        <td>
                            <input
                                ...
                                onChange={event =>
                                    onInputChange(event.target.value, 'telMob2')
                                }
                                size="25"
                                autoComplete="off"
                                maxLength="15"
