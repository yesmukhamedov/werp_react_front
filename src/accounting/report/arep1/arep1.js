...
class Arep1 extends Component {
    ...
    onInputChange(value, stateFieldName) {
        ...
        if (
            ...
            stateFieldName === 'bukrs' ||
            stateFieldName === 'branchList'
        ) {
    ...
    fetchHkontOptions(bukrs, branchList) {
        return doGet('core/accounting/reports/arep1/hkonts', {
            bukrs,
    ...
    exportExcel(a_type) {
        ...
        if (a_type === 'total') {
            ...
            excelDownload(
                'core/accounting/reports/arep1/downloadTotal',
                'Arep1Total.xls',
                'outputTable',
            ...
            excelDownload(
                'core/accounting/reports/arep1/downloadDetail',
                'Arep1Detail.xls',
                'outputTableDetail',
            ...
            return (
                <Table.Row key={idx}>
                    ...
                    <Table.Cell active={wa.hkont === ''}>
                        <font color="green">
                            {wa.hkont === '' && (
                                <strong>{moneyFormat(wa.wrbtr_s)} </strong>
                            )}
                    ...
                    <Table.Cell active={wa.hkont === ''}>
                        <font color="red">
                            {wa.hkont === '' && (
                                <strong>{moneyFormat(wa.wrbtr_h)} </strong>
                            )}
                    ...
                    <Table.Cell active={wa.hkont === ''}>
                        <font color="green">
                            {wa.hkont === '' && (
                                <strong>{moneyFormat(wa.dmbtr_s)} </strong>
                            )}
                    ...
                    <Table.Cell active={wa.hkont === ''}>
                        <font color="red">
                            {wa.hkont === '' && (
                                <strong>{moneyFormat(wa.dmbtr_h)} </strong>
                            )}
    ...
    render() {
        ...
        let t1r1c12 = {
            ...
            filterMethod: (filter, rows) =>
                matchSorter(rows, filter.value, {
                    keys: [
                        { threshold: rankings.CONTAINS, key: 'customerName' },
                    ],
                }),
            filterAll: true,
        };
        ...
        return (
            ...
            >
                ...
                <Segment className={activeIndex === 1 ? 'show' : 'hide'}>
                    {this.props.outputTable &&
                        this.props.outputTable.length > 0 && (
