...
import {  Container, Header, Segment, List, Button, Icon, Table, Dropdown, Input, Label  } from 'semantic-ui-react';
...
import {clearfaBkpf, changefaBkpf, fetchIncomeHkontsByBukrs} from '../../../finance/fa_action';
...
class Amri extends Component {
    ...
    save(){      
      ...
      if (errors===null || errors===undefined || errors.length===0){       
        ...
        let args = {bkpf,amount:this.state.amount,lifnr:this.state.lifnr, hkont_h:this.state.hkont_h};
        this.props.saveAccSrcDocs(args,'AMRI',()=>this.initializeBkpfBseg());
      }
      else{
    ...
    validate(){
      ...
      const {lifnr, hkont_h, amount} = this.state;
      if (lifnr===null || lifnr===undefined || !lifnr) { errors.push(errorTable['9'+language]); }
      if (hkont_h===null || hkont_h===undefined || !hkont_h) { errors.push(errorTable['12'+language]); }
    ...
    render(){
      ...
      const hkont_h = this.state.hkont_h;      
      const {formatMessage} = this.props.intl;
        ...
        return (
            ...
            <Container fluid style={{ marginTop: '2em', marginBottom: '2em', paddingLeft: '2em', paddingRight: '2em'}}>
                <Header as="h2" block>
                  {formatMessage(messages.transNameAmri)} 
                </Header>
                            ...
                            <Table.Header>
                                ...
                                <Table.Body>
                                    ...
                                    <Table.Cell>
                                        ...
                                        <Table.Cell>
                                            <Dropdown fluid search selection options={this.props.hkontOptions?this.props.hkontOptions:[]} 
...
export default connect(mapStateToProps,{ f4FetchDepartmentList, f4FetchCurrencyList, modifyLoader,
  f4FetchExchangeRateNational, changefaBkpf, clearfaBkpf, fetchIncomeHkontsByBukrs,saveAccSrcDocs }) (injectIntl(Amri));
