...
import {clearfaBkpf, changefaBkpf, fetchExpenseHkontsByBukrs} from '../../../finance/fa_action';
...
class Ampi extends Component {
    ...
    save(){      
      ...
      if (errors===null || errors===undefined || errors.length===0){        
        ...
        let args = {bkpf,amount:this.state.amount,lifnr:this.state.lifnr, hkont_s:this.state.hkont_s};
    ...
    validate(){
      ...
      if (hkont_s===null || hkont_s===undefined || !hkont_s) { errors.push(errorTable['12'+language]); }
...
export default connect(mapStateToProps,{ f4FetchDepartmentList, f4FetchCurrencyList, modifyLoader,
  f4FetchExchangeRateNational, changefaBkpf, clearfaBkpf, fetchExpenseHkontsByBukrs,saveAccSrcDocs }) (injectIntl(Ampi));
