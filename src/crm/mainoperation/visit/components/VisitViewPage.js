...
class VisitViewPage extends Component {
  ...
  renderActions (messages) {
    return <div>
      ...
      <Button color={'red'} onClick={() => this.deleteVisit(messages)}>{messages['Crm.ToDelete']}</Button>
    </div>
  }
      ...
      <Container fluid style={{ marginTop: '2em', marginBottom: '2em', paddingLeft: '2em', paddingRight: '2em'}}>
        ...
        <Grid>
          <Grid.Row>
            ...
            <Grid.Column width={8}>
              {<ChildRecosTable messages={messages} items={visit.recos || []}/>}
                {<ChildDemosTable messages={messages} items={visit.childDemos || []}/>}
            </Grid.Column>
          </Grid.Row>
        </Grid>
      </Container>
