...
export default function RecoCard(props){
    ...
    //Single Card
    const {item,index,phoneErrors,loadingPhones,phonePattern,recoErrors,messages,locale,errors} = props;
        ...
        <Segment padded size='small' className='card-segment'>
            ...
            <Form className='recoGrid'>
                <Form.Input
                        ...
                        onChange={(e,d) => props.handleChange('clientName',index,d.value)}
                ...
                <Form.Dropdown
                    ...
                    onChange={(e,d) => props.handleChange('categoryId',index,d.value)}  />
                ...
                <Form.Input
                            ...
                            onChange={(e,d) => props.handleChange('districtName',index,d.value)}
                ...
                <Form.Input value={item.relativeName || ''}
                            ...
                            onChange={(e,d) => props.handleChange('relativeName',index,d.value)} />
                ...
                <Form.Dropdown
                   ...
                   placeholder={messages['Form.Reco.CallerIs']}
                    ...
                    onChange={(e,d) => props.handleChange('callerIsDealer',index,d.value)}  />
                ...
                <Form.Field error={phoneHasError('phoneNumber1')}>
                    ...
                    <Input
                        ...
                        onChange={(e,d) => props.handleChange('phoneNumber1',index,d.value)}
                ...
                <Form.Field error={phoneHasError('phoneNumber2')}>
                    ...
                    <Input
                            label={{ basic:true,content:props.phoneCode}}
                           placeholder={phonePattern}
                            onChange={(e,d) => props.handleChange('phoneNumber2',index,d.value)}
