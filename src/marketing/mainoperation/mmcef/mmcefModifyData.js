        ...
        if (contract) {
            ...
            if (
                ...
                props.fetchDynObjMarketing(
                    'core/marketing/contract/priceListF4/fetch_price_list',
                    {
    ...
    return (
        <div>
            ...
            <StaffF4Modal
                ...
                onStaffSelect={item =>
                    props.onInputChange(item, staffF4ModalPosition)
                }
                trans="mmcef"
            ...
            <RecommenderF4Modal
                ...
                onCloseRecommenderListF4={bool =>
                    setRecommenderF4ModalOpen(bool)
                }
                onRecommenderSelect={item =>
                    props.onInputChange(item, 'refContractId')
                }
                trans="mmcef"
                bukrs={contract.bukrs}
            />
            ...
            <Table collapsing className="borderLess">
                <Table.Body>
                    <Table.Row>
                        ...
                        <Table.Cell>
                            {renderSaveButton('contractStatusId')}
                        </Table.Cell>
                    </Table.Row>
                    <Table.Row>
                    ...
                    <Table.Row>
                        ...
                        <Table.Cell>
                            ...
                            <Icon
                                ...
                                color="red"
                                onClick={event =>
                                    props.onInputChange('', 'demoScRemove')
                                }
                            />
                        </Table.Cell>
                    ...
                    <Table.Row>
                        ...
                        <Table.Cell>
                            {renderSaveButton('refContractId')}
                        </Table.Cell>
                    </Table.Row>
                    <Table.Row>
                        ...
                        <Table.Cell>
                            {renderSaveButton('legalEntityId')}
                        </Table.Cell>
                    </Table.Row>
                    ...
                    <Table.Row>
                        ...
                        <Table.Cell>
                            {renderSaveButton('dealerSubtract')}
                        </Table.Cell>
                    </Table.Row>
