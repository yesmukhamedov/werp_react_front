...
const Mmcei = props => {
    ...
    const onSearchContract = contractNumber => {
        props.fetchDynObjMarketing(
            'core/marketing/contract/mmcei/fetchContract',
    ...
    const onInputChangeContractDescription = (value, fieldName) => {
        setNewContractDescription(prev => {
            ...
            if (value.length > 0)
                setIsDisabledSaveContractDescriptionButton(false);
    ...
    const onSave = () => {
        props.onSaveMmcTrans(
            'core/marketing/contract/mmcei/saveContract',
            {
                contract,
                newContract,
    ...
    const onSaveContractDescription = () => {
        props.onSaveMmcTrans(
            'core/marketing/contract/mmcei/addContractDescription',
            {
                contract,
                contractDescriptionList,
                                ...
                                <Table.Row>
                                    <Table.Cell>
                                        <TextArea
                                            ...
                                            value={
                                                newContractDescription.description
                                            }
                                            maxLength="255"
                                            onChange={(e, { value }) =>
                                                onInputChangeContractDescription(
                                                    value,
                                                    'description',
                                                )
                                            }
