...
const MmccLogistics = props => {
    ...
    useEffect(() => {
        ...
        if (
            ...
            props.fetchDynObjMarketing(
                'core/marketing/contract/matnrF4/fetch_matnr_list',
                { bukrs, tcode, branchId, contractTypeId, dealer },
                bool => setIsLoadingMatnrList(bool),
            );
            props.fetchDynObjMarketing(
                'core/marketing/contract/tradeInMatnrF4/fetch_tradeInMatnr_list',
    ...
    useEffect(() => {
        ...
        if (branchId && branchId > 0) {
            props.fetchDynObjMarketing(
                'core/marketing/contract/promoF4/fetch_promo_list',
        ...
        <div>
          ...
          <Label color="orange" ribbon>
            ...
            <TradeInMatnrListF4Modal
                ...
                onCloseTradeInMatnrF4={bool =>
                    setTradeInMatnrListF4ModalOpen(bool)
                }
            ...
            <PromoListF4Modal
                ...
                onPromoSelect={item =>
                    props.onLogisticsInputChange(item, 'promo')
                }
                        ...
                        <Table.Row>
                            ...
                            <Table.Cell>
                                ...
                                <Icon
                                    ...
                                    onClick={() =>
                                        setTradeInMatnrListF4ModalOpen(true)
                                    }
                                />
                                <Icon
                                    name="remove"
