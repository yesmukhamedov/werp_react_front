...
const Mmceg = props => {
    ...
    const onSearchContract = contractNumber => {
        props.fetchDynObjMarketing(
            'core/marketing/contract/mmceg/fetchContract',
    ...
    const renderContractPromoButtons = () => {
        if (
            contractPromoList.length === 0 &&
            newContractPromoList.length === 0
        ) {
            return (
                <Icon
                    name="clone"
                        ...
                        <Table collapsing>
                            <Table.Body>
                                <Table.Row>
                                    ...
                                    <Table.Cell>
                                        <Input
                                            value={newContract.matnrReleaseDate}
                                        />
                                    </Table.Cell>
                                </Table.Row>
                                <Table.Row>
                                    ...
                                    newContract.tradeIn > 0 && (
                                        <Table.Row>
                                            ...
                                            <Table.Cell>
                                                <Input
                                                    value={
                                                        newContract.tradeInTovarSerial
                                                    }
                                                    maxLength="18"
                                                />
                                            </Table.Cell>
