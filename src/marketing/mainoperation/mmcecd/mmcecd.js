...
const Mmcecd = props => {
    ...
    useEffect(() => {
        ...
        if (mmcecd && mmcecd.oldAddrHome)
            setOldAddrHome({ ...mmcecd.oldAddrHome });
        if (mmcecd && mmcecd.oldAddrService)
            setOldAddrService({ ...mmcecd.oldAddrService });
        if (mmcecd && mmcecd.oldAddrWork)
            setOldAddrWork({ ...mmcecd.oldAddrWork });

        if (mmcecd && mmcecd.oldAddrHome)
            setNewAddrHome({ ...mmcecd.oldAddrHome });
        if (mmcecd && mmcecd.oldAddrService)
            setNewAddrService({ ...mmcecd.oldAddrService });
        if (mmcecd && mmcecd.oldAddrWork)
            setNewAddrWork({ ...mmcecd.oldAddrWork });
    ...
    const onSearchContract = contractNumber => {
        props.fetchDynObjMarketing(
            'core/marketing/contract/mmcecd/fetchContract',
    ...
    const onSave = () => {
        props.onSaveMmcTrans(
            'core/marketing/contract/mmcecd/saveContract',
            {
                contract,
                newContract,
                oldAddrHome,
        ...
        >
            ...
            <AddressF4Modal
                ...
                onAddressSelect={item =>
                    onInputChange(item, addressF4ModalType)
                }
                countryId={countryId}
            />
                            ...
                            <Table collapsing className="borderLess">
                                ...
                                <Table.Body>
                                    ...
                                    <Table.Row>
                                        ...
                                        <Table.Cell>
                                            <span>
                                                {newAddrService.telMob1}
                                            </span>
                                        </Table.Cell>
                                        <Table.Cell>
                                            <span>
                                                {newAddrService.telMob2}
                                            </span>
                                        </Table.Cell>
                                        <Table.Cell>
                                            <span>
