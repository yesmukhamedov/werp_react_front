...
import LazyCustSearch from './lazyCustSearch';
    ...
    return (
      <div>
        ...
        <LazyCustSearch
          ...
          lazymeta={this.props.lazymeta}
          lazyitems={this.props.lazyitems}
          lazycustomer={this.props.lazycustomer}
          selCustomerRow={this.selCustomerRow}
          modalClose={this.modalClose}
          handleLazySearch={this.handleLazySearch}
