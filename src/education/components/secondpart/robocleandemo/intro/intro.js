              ...
              <Grid.Column width="8" verticalAlign="middle">
                ...
                <p>
                  <i>
                    ...
                    қызмет көрсетумен айналысады. Aura компаниясы маркетинг және
                    сервистік қызметі бойынша әлемде 3-ші орында, ал Орта Азияда
                    1-орынға ие. Сатып алушылардың көп болуы - тауардың сапасы
                    мен сервистік қызметтің жоғарғы деңгейде екендігін
              ...
              <Grid.Column width="8" verticalAlign="middle">
                ...
                <p>
                  <i>
                    ...
                    танысып, қатты ұнатты. Берікке менен үлкен сәлем айт деді.
                    Алина, Қарлығашта сізге де үлкен сәлем айтты. Берік пен
                    Алинаға міндетті түрде Roboclean-ды таныстыр, себебі Алинаны
                    тазалыққа, денсаулыққа қатты мән береді деп, сізгдерге
                    таныстыруымды өтінді. Тазалыққа қатты мән беретініңіз
                    үйіңізден бірден көрініп тұр. Айтқанындай олардың Алмас
                    деген ұлы сіздердің ұлдарыңызбен бірге күреске қатысады деп
                    еді.
                  </i>
                </p>
              </Grid.Column>
