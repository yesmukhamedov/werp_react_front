  ...
  return (
    <div className="carpet">
      <Container textAlign="justified">
        ...
        <Accordion fluid styled className="carpet__content__acc">
            ...
            <Grid>
                ...
                <Grid.Column width="8" verticalAlign="middle">
                  <p>
                    ...
                    <i>
                      ...
                      туғызады. Кілемнің арасындағы шаңды тазалау үшін оның
                      түгін тарап, қағу керек. Кілемді сыртқа шығарып қағатын
                      кездеріңіз болады ма? Кілемдерімізді далаға шығарып
                      қағудың өзі үлкен жұмыс. Үлкен ауыр кілемдерді далаға
                      шығару қолайсыз әрі ауыр. Оны қағам деп шаңнын быразын
                      өзіміз жұтамыз, быразы қайта кілемге жабысады, әйтеуір
                      шаңы бітпесе де шаршаған соң қайта үйге әкеле саламыз,
                      солай емес пе?
                    </i>
                  </p>
                </Grid.Column>
              ...
              <Grid.Row>
                <Grid.Column>
                  <p>
                    <i>
                      &nbsp; Алина генеральный уборка жасайтын кезде, Берік,
                      бүгіннен бастап бұл проблемалардың барлығын ұмытасыздар.
                      Себебі қолымызда Power Nozzle насадкасы бар. Бұл кілемді
                      жатқан жерінен минутына 7000 рет қағады, түктерін тарайды,
                      түбіндегі құм, шаңдардың барлығын Roboclean-нің бачогына
                      жинайды. Бұдан былай тазалықты рахатықпен жасайсыздар.
                      <br />
