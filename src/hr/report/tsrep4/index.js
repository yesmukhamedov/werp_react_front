...
function TSRep4(props) {
    ...
    const exportExcel = messages => {
        ...
        excelHeaders.push(messages['count_laidoff_employees']);
        excelHeaders.push(messages['count_remaining_employees']);
        excelDownload(
            'core/hr/tsrep/firremained/excel',
            'tsrep.xls',
            'outputTable',
            props.dynamicObject,
            excelHeaders,
    ...
    return (
        ...
        >
            ...
            <Divider />
            {dynamicObject.length === undefined ||
            dynamicObject.length === 0 ? (
                ''
            ) : (
                <Segment>
                    <Image
