...
import {createDocument,fetchDocument,handleAction} from '../actions/hrDocAction'
...
class HrDocUpdatePage extends Component{
    ...
    render (){
        ...
        let form;
        let pageTitle = localDocument.id ? 'Редактирование документа ' + localDocument.typeName + ' №' + localDocument.id : '';
        ...
        return <Container fluid style={{ marginTop: '2em', marginBottom: '2em', paddingLeft: '2em', paddingRight: '2em'}}>
            <Segment clearing>
                ...
                {modal}
                <HrDocActions isUpdate={true} handleAction={this.handleAction} items={[]} />
            </Segment>
            <Divider clearing />
...
export default connect(mapStateToProps, {
    toggleStaffListModal,createDocument,fetchAllDirectors,
    f4FetchPositionList,f4FetchBusinessAreaList,f4FetchDepartmentList,fetchAllManagers,
    toggleSalaryListModal,fetchDocument,handleAction
