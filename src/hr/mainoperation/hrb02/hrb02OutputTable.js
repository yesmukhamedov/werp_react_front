...
class Hrb02OutputTable extends PureComponent {
  ...
  fillTableColumns = () => {
    ...
    let t1r1c1 = {
      Header: ({ value }) => <b>Материал</b>,
      accessor: 'matnrName',
    };
    let t1r1c2 = {
      Header: ({ value }) => <b>Тип бонуса</b>,
      accessor: 'bonusTypeName',
      width: 200,
    };
    let t1r1c3 = {
      Header: ({ value }) => <b>Категория</b>,
      accessor: 'category_id',
      Cell: ({ value }) => this.bonusCategoryName(value),
      width: 200,
    };
    let t1r1c4 = {
      Header: ({ value }) => <b>Должность</b>,
      accessor: 'positionName',
    };
    let t1r1c5 = {
      Header: ({ value }) => <b>Продожа от</b>,
      accessor: 'from_num',
      width: 100,
    };
    let t1r1c6 = {
      Header: ({ value }) => <b>Продажа по</b>,
      accessor: 'to_num',
      width: 100,
    };
    let t1r1c7 = {
    ...
    let t1r1c9 = {
      Header: ({ value }) => <b>Депозит</b>,
      accessor: 'deposit',
      width: 100,
    };
    let t1r1c10 = {
      Header: ({ value }) => <b>Min</b>,
      accessor: 'req_value',
      width: 100,
    };
    let t1r1c11 = {
      Header: ({ value }) => <b />,
      accessor: 'rowStatus',
      Cell: ({ value }) => this.displayIconStatus(value),
      width: 40,
    };
    let t1r1c12 = {
      Header: ({ value }) => <b />,
      ...
      Cell: obj => (
        <span>
          <Icon
            ...
            onClick={event =>
              this.props.bonusEditModalOpenHandler(obj.index, obj.original)
            }
          />
          <Icon
            name="remove"
            ...
            className="clickableIcon"
            color="red"
            onClick={() => this.props.onDeleteRow(obj.index)}
          />
        </span>
      ),
      width: 80,
    ...
    let t1r1c13 = {
      Header: ({ value }) => <b>Срок</b>,
      accessor: 'term_in_month',
      width: 40,
    };
