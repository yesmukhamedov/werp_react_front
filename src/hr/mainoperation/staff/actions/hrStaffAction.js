...
export function fetchExitInterviews(params) {
    return function(dispatch) {
        dispatch(modifyLoader(true));
        doGet('core/hr/exit-interviews', params)
            .then(({ data }) => {
                dispatch(modifyLoader(false));
                dispatch({
...
export function blankExitInterview(staffId) {
    return dispatch => doGet(`core/hr/exit-interviews/blank/` + staffId);
}

export function fetchAllCurrentStaffs(params) {
    return function(dispatch) {
        dispatch(modifyLoader(true));
        doGet(`core/hr/staff/current-all`, params)
            .then(({ data }) => {
                dispatch(modifyLoader(false));
                dispatch({
...
export function saveExitInterview(model) {
    return function(dispatch) {
        dispatch(modifyLoader(true));
        const uri = 'core/hr/exit-interviews';
...
export function fetchBranchPyramids(branchId) {
    return function(dispatch) {
        doGet(`core/hr/pyramid/tree/by-branch/${branchId}`)
            .then(({ data }) => {
                dispatch({
...
export function downloadFile(fileId) {
    return function(dispatch) {
        doPost(`core/hr/file/download/${fileId}`, {})
            .then(({ data }) => {
                console.log(data);
            })
            .catch(error => {
...
export function deleteFile(staffId, fileId) {
    return function(dispatch) {
        doDelete(`core/hr/file/${staffId}/${fileId}`)
            .then(({ data }) => {
                dispatch({
...
export function fetchAllDirectors() {
    return function(dispatch) {
        doGet(`core/hr/salary/directors`)
            .then(({ data }) => {
                dispatch({
...
export function blankStaffExperience() {
    return dispatch => doGet(`core/hr/staff/blank-experience`);
}

export function fetchMaritalStatuses() {
    return function(dispatch) {
        doGet(`core/hr/staff/marital-statuses`)
            .then(({ data }) => {
                dispatch({
...
export function fetchMaritalStatusOptions() {
    return function(dispatch) {
        doGet(`core/hr/staff/marital-statuses?dto-type=options`)
            .then(({ data }) => {
                dispatch({
