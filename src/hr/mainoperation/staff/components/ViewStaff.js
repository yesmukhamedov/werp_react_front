...
class ViewStaff extends Component {
    ...
    handleTabChange(e, data) {
        ...
        if (data.activeIndex === 2) {
            ...
            if (
                !this.state.staff ||
                !this.state.staff.hasOwnProperty('staff_id')
            ) {
                this.setState({
                    ...this.state,
                    salaries: [],
                ...
                doGet(`core/hr/staff/${this.state.staff.staff_id}/salaries`)
                    .then(response => {
                        this.setState({
                            ...this.state,
            ...
            doGet(`core/hr/staff/${this.state.staff.staff_id}/expenses`)
                .then(response => {
                    this.setState({
                        ...this.state,
            ...
            doGet(`core/hr/staff/${this.state.staff.staff_id}/official-data`)
                .then(response => {
                    this.setState({
                        ...this.state,
            ...
            <Table celled striped>
                <Table.Body>
                    ...
                    <Table.Row>
                        ...
                        <Table.Cell>
                            {this.formatTimestamptToDate(stf.birthday)}
                        </Table.Cell>
                    </Table.Row>
                    ...
                    <Grid.Column width={8}>
                        <Grid celled>
                            ...
                            <Grid.Row>
                                ...
                                <Grid.Column width={7}>
                                    {this.formatTimestamptToDate(
                                        stf.passport_given_date,
                                    )}
                                </Grid.Column>
                            </Grid.Row>
                            <Grid.Row>
