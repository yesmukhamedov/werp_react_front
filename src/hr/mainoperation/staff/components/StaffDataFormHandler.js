...
class StaffDataFormHandler extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.staffData.id !== this.state.localItem.id) {
      const localItem = Object.assign({}, nextProps.staffData);
      this.setState({
        ...this.state,
        localItem,
      });
        ...
        return (
          <SalaryForm
            ...
            businessAreaOptions={businessAreaOptions(
              this.props.businessAreaList,
              localItem.bukrs,
            )}
            pyramidOptions={pyramidOptions(
              this.props.branchPyramids,
              localItem.branchId,
            )}
  ...
  onSubmit() {
    if (
      !this.state.localItem.id ||
      typeof this.state.localItem.id === 'undefined'
    ) {
