...
class StaffForm extends Component {
    ...
    loadRegions(cityId) {
        doGet(`core/reference/regions/${cityId}`)
            .then(response => {
    ...
    loadCities(stateId) {
        doGet(`core/reference/cities/${stateId}`)
            .then(response => {
    ...
    loadStates(countryId) {
        doGet(`core/reference/states/${countryId}`)
            .then(response => {
    ...
    submitForm() {
        ...
        doPost(`core/hr/staff`, this.state.staff)
            .then(response => {
                    ...
                    <div className="ui secondary segment">
                        ...
                        <Form.Group widths="equal">
                            <Form.Input
                                ...
                                placeholder="ИИН"
                                onChange={e =>
                                    this.onInputChange('iin', e.target.value)
                                }
                            />
                            <Form.Field>
                            ...
                            <Form.Select
                                ...
                                placeholder="Пол"
                                onChange={e =>
                                    this.onInputChange('gender', e.target.value)
                                }
                            />
                        </Form.Group>
                    </div>
