      ...
      <Form.Group widths="equal">
        <Form.Field required>
          ...
          <DatePicker
            ...
            selected={model.begDate ? moment(model.begDate) : null}
      ...
      <Form.Group widths="equal">
        <Form.Field required>
          ...
          <DatePicker
            ...
            dropdownMode="select"
            dateFormat="DD.MM.YYYY"
            selected={model.endDate ? moment(model.endDate) : null}
