    ...
    const onCustomerChange = (value, stateFieldName) => {
        setCustomer(prev => {
            ...
            if (stateFieldName === 'fizYur') {
                ...
                waCustomer.firstname = value;
            else if (stateFieldName === 'lastname') waCustomer.lastname = value;
            else if (stateFieldName === 'middlename')
                waCustomer.middlename = value;
            else if (stateFieldName === 'passportId')
                waCustomer.passportId = value;
                ...
                //   ? moment(value).format('YYYY-MM-DD')
                //   : null;
            } else if (stateFieldName === 'countryId')
                waCustomer.countryId = value;
            else if (stateFieldName === 'director') waCustomer.director = value;
            else if (stateFieldName === 'accountant')
                waCustomer.accountant = value;
