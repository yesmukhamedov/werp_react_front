...
import {toggleFormModal,createPyramid,updatePyramid} from '../actions/hrPyramidAction'
  ...
  componentWillReceiveProps (nextProps) {
    ...
    saveItem(){
        ...
        if(localItem.id && typeof localItem.id !== 'undefined' && localItem.id > 0){
            this.props.updatePyramid(localItem)
        }else{
            this.props.createPyramid(localItem)
        }
    }
...
export default connect(mapStateToProps, {toggleFormModal,createPyramid,updatePyramid})(PyramidFormModal)