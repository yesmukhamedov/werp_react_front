...
class Serrep4 extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      currentTable: [],
      resultDate: '',
      pylSelectedPageNumber: 1,
      filterSelectedPageNumber: 1,
      currentSelectedPageNumber: 1,
      pylRowNumbers: 0,
      pylTotalPageNumbers: 1,
      filterRowNumbers: 0,
      filterTotalPageNumbers: 1,
    };
  }
  ...
  onSelectTableType(index) {
    if (index === 1) {
      this.setState({
        ...
        button2: false,
        button3: false,
        currentSelectedPageNumber: this.state.pylSelectedPageNumber,
      });
    } else if (index === 2) {
      this.setState({
        ...this.state,
      ...
      this.setState({
        ...
        button2: false,
        button3: true,
        currentSelectedPageNumber: this.state.filterSelectedPageNumber,
      });
    }
  }
  ...
  renderTable() {
    if (
      this.state.currentTable[this.state.currentSelectedPageNumber - 1] == null
    )
      return '';
    return this.state.currentTable[
      this.state.currentSelectedPageNumber - 1
    ].list.map((wa, idx) => (
      <Table.Row key={idx}>
        ...
        <Table.Cell>
          {new Intl.NumberFormat('ru-RU').format(wa.zavodCena)}
        </Table.Cell>
                ...
                <Table compact>
                  <Table.Body>
                    ...
                    <Table.Row>
                      ...
                      <Table.Cell>
                        <Checkbox
                          checked={this.state.searchTerm.warranty}
                          onChange={(event, { value }) =>
                            this.onInputChange(value, 'warranty')
                          }
                        />
                      </Table.Cell>
                      <Table.Cell />
                      ...
                      <Table.HeaderCell>
                        ...
                        <div>
                          <Input
                            ...
                            placeholder="Поиск"
                            onChange={(e, { value }) =>
                              this.onSearchColumn(value, 'code')
                            }
                          />
                        </div>
                      </Table.HeaderCell>
                      <Table.HeaderCell>
                        ...
                        <div>
                          <Input
                            ...
                            placeholder="Поиск"
                            onChange={(e, { value }) =>
                              this.onSearchColumn(value, 'matnrName')
                            }
                          />
                        </div>
                      </Table.HeaderCell>
                  ...
                  <Table.Footer>
                    <Table.Row>
                      <Table.HeaderCell colSpan="5">
                        {this.state.button2 && (
                          <SemanticPagination
                            rowNumbers={this.state.pylRowNumbers}
                            pageNumbers={this.state.pylTotalPageNumbers}
                            selectedPageNumber={
                              this.state.pylSelectedPageNumber
                            }
                            selectPageNumber={selectedPageNumber =>
                              this.setState({
                                pylSelectedPageNumber: selectedPageNumber,
                                currentSelectedPageNumber: selectedPageNumber,
                              })
                            }
                          />
                        )}
                        ...
                        {this.state.button3 && (
                          <SemanticPagination
                            rowNumbers={this.state.filterRowNumbers}
                            pageNumbers={this.state.filterTotalPageNumbers}
                            selectedPageNumber={
                              this.state.filterSelectedPageNumber
                            }
                            selectPageNumber={selectedPageNumber =>
                              this.setState({
                                filterSelectedPageNumber: selectedPageNumber,
                                currentSelectedPageNumber: selectedPageNumber,
                              })
                            }
                          />
