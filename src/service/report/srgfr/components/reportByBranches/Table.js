...
const Table = ({ data, intl: { messages } }) => {
  const columns = [
    ...
    {
      Header: messages['salary_of_manager_and_coordinator'],
      accessor: 'managerAndCoordinatorSalary',
      Cell: row => <TextAlignCenter text={row.value} />,
      filterAll: true,
    },
    {
      Header: messages['bonus_of_manager'],
      accessor: 'managerPremium',
      Cell: row => <TextAlignCenter text={row.value} />,
      filterAll: true,
    },
    {
      Header: messages['total_profit_in_tg'],
      accessor: 'profitSum',
      Cell: row => <TextAlignCenter text={row.value} />,
      filterAll: true,
    },
    {
      Header: messages['total_profit_in_percent'],
      accessor: 'profitSumInPercent',
      Cell: row => <TextAlignCenter text={row.value} />,
      filterAll: true,
    },
    {
      Header: messages['consumables'],
