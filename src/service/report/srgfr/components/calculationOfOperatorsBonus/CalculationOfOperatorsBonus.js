...
import { fetchCalculationOfOperatorsBonus } from '../../srgfrAction';
import Table from './Table';
import { Form, Icon } from 'semantic-ui-react';

const CalculationOfOperatorsBonus = props => {
    const {
        intl: { messages },
        language,
        countries = [],
    ...
    const apply = () => {
        if (validation()) {
            props.fetchCalculationOfOperatorsBonus(filterParams);
        }
    };
...
export default connect(mapStateToProps, {
    f4FetchCountryList,
    fetchCalculationOfOperatorsBonus,
})(injectIntl(CalculationOfOperatorsBonus));
