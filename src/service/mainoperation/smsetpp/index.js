    ...
    const getProductOptions = (productList, bukrs, countryId) => {
        ...
        if (countryId !== 9) {
            for (i = 0; i < productList.length; i++) {
                if (
                    productList[i].bukrs === bukrs &&
                    productList[i].countryId !== 9
                ) {
            ...
            <Form>
                ...
                <Form.Group className="alignBottom" widths="equal">
                    <Form.Field required>
                        ...
                        <DropdownClearable
                            ...
                            onChange={(e, { value }) =>
                                onChange('companyOptions', value)
                            }
                            handleClear={() =>
                                setSearch({ ...search, bukrs: '' })
                            }
                        />
                    </Form.Field>
                    ...
                    <Form.Field>
                        ...
                        <DropdownClearable
                            ...
                            value={
                                search.serviceTypeId ? search.serviceTypeId : ''
                            }
                            onChange={(e, { value }) =>
                                onChange('serviceType', value)
                            }
                            handleClear={() =>
                                setSearch({ ...search, serviceTypeId: '' })
                            }
                        />
                    </Form.Field>
                ...
                <ReactTableWrapperFixedColumns
                    ...
                    columns={[
                        ...
                        {
                            Header: () => (
                                <div style={{ textAlign: 'center' }}>FC</div>
                            ),
                            accessor: 'fc',
                            Cell: row => (
                                <div style={{ textAlign: 'center' }}>
                        ...
                        {
                            Header: () => (
                                <div style={{ textAlign: 'center' }}>MC</div>
                            ),
                            accessor: 'mc',
                            Cell: row => (
                                <div style={{ textAlign: 'center' }}>
                ...
                <ReactTableWrapperFixedColumns
                    ...
                    pageSize={
                        smsetppHistory.length < 10 ? smsetppHistory.length : 10
                    }
                    showPagination={true}
                    pageSizeOptions={[10, 20, 30, 40]}
                />
...
const mapStateToProps = state => {
    return {
        ...
        smsetppServiceType:
            state.serviceReducer.dynamicObject.smsetppServiceType,
