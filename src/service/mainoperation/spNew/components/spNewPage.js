...
class SpNewPage extends Component {
    ...
    componentWillMount() {
        axios
            .all([
                ...
                doGet(`core/reference/product-categories`),
            ])
            .then(
                axios.spread(
                    (
    ...
    fetchReferenceList(companyId, countryId, productId) {
        axios
            .all([
                doGet(
                    `core/reference/spare-part-warranties?productId=${productId}`,
                ),
                doGet(
                    `core/reference/spare-part-prices?companyId=${companyId}&countryId=${countryId}&productId=${productId}`,
                ),
            ])
            .then(
