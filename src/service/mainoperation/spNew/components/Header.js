                    ...
                    <div className="ui four column doubling grid">
                        <div className="column">
                            <div className="field">
                                ...
                                <input name="name" placeholder="Введите название сервис пакета" type="text"/>
                        ...
                        <div className="column">
                            ...
                            <div className="field">
                                ...
                                <div className="ui fluid search selection dropdown">
                                    ...
                                    <div className="menu">
                                        <div className="item" data-value="cleaning">Уборочная система</div>
                                        <div className="item" data-value="waterCleaning">Система очистки воды</div>
                                    </div>
                                </div>
                            </div>
                            <div className="field">
