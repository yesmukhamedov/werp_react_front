...
const AsyncHrb02 = Loadable({
    loader: () =>
        import(
            '../hr/mainoperation/hrb02/hrb02' /* webpackChunkName: "hrb02" */
        ),
    loading: () => <LoadingPage />,
});
...
const AsyncFrcoln = Loadable({
    loader: () =>
        import(
            '../finance/report/frcoln/frcoln' /* webpackChunkName: "frcoln" */
        ),
    loading: () => <LoadingPage />,
});
...
const AsyncArep1 = Loadable({
    loader: () =>
        import(
            '../accounting/report/arep1/arep1' /* webpackChunkName: "arep1" */
        ),
    loading: () => <LoadingPage />,
});
...
const AsyncFmcp = Loadable({
    loader: () =>
        import(
            '../finance/mainoperation/fmcp/fmcp' /* webpackChunkName: "fmcp" */
        ),
    loading: () => <LoadingPage />,
});
...
const AsyncFcis = Loadable({
    loader: () =>
        import(
            '../finance/mainoperation/fcis/fcis' /* webpackChunkName: "fcis" */
        ),
    loading: () => <LoadingPage />,
});
...
const AsyncFaia = Loadable({
    loader: () =>
        import(
            '../finance/mainoperation/faia/faia' /* webpackChunkName: "faia" */
        ),
    loading: () => <LoadingPage />,
});
...
const AsyncFa02 = Loadable({
    loader: () =>
        import(
            '../finance/mainoperation/fa02/fa02' /* webpackChunkName: "fa02" */
        ),
    loading: () => <LoadingPage />,
});
...
const AsyncFa03 = Loadable({
    loader: () =>
        import(
            '../finance/mainoperation/fa03/fa03' /* webpackChunkName: "fa03" */
        ),
    loading: () => <LoadingPage />,
});
...
const AsyncAesreport1 = Loadable({
    loader: () =>
        import('../aes/report/aesReport' /* webpackChunkName: "aes" */),
    loading: () => <LoadingPage />,
});
...
const AsyncDitEllist = Loadable({
    loader: () =>
        import('../dit/ditellist/' /* webpackChunkName: "ditellist" */),
    loading: () => <LoadingPage />,
});
...
const AsyncDmscList = Loadable({
    loader: () =>
        import(
            '../marketing/report/dmsclist' /* webpackChunkName: "dmsclist" */
        ),
    loading: () => <LoadingPage />,
});
...
const AsyncInterPhones = Loadable({
    loader: () =>
        import('../dit/phoneBook' /* webpackChunkName: "phoneBook" */),
    loading: () => <LoadingPage />,
});
...
const AsyncTSRep1 = Loadable({
    loader: () =>
        import('../hr/report/tsrep1' /* webpackChunkName: "tsrep1" */),
    loading: () => <LoadingPage />,
});

const AsyncTSRep2 = Loadable({
    loader: () =>
        import('../hr/report/tsrep2' /* webpackChunkName: "tsrep2" */),
    loading: () => <LoadingPage />,
});

const AsyncTSRep3 = Loadable({
    loader: () =>
        import('../hr/report/tsrep3' /* webpackChunkName: "tsrep3" */),
    loading: () => <LoadingPage />,
});

const AsyncTSRep4 = Loadable({
    loader: () =>
        import('../hr/report/tsrep4' /* webpackChunkName: "tsrep4" */),
    loading: () => <LoadingPage />,
});
//roboclean education
...
const generateRoutes = transactionRoutes => {
    return (
        <div style={{ height: '100%' }}>
            ...
            <Route
                path="/newIssue/:id"
                component={AsyncNewIssuePageContainer}
            />
            <Route
                path="/hr/staff/update/:id?"
                component={AsyncStaffUpdatePage}
            />
            ...
            <Route
                ...
                component={AsyncHrRecruitmentPage}
            />
      ...
      <Route path="/marketing/mainoperation/mmceg" component={AsyncMmceg} /> */}
            <Route
                path="/marketing/mainoperation/mmcef"
                component={AsyncMmcef}
            />
            <Route
                path="/marketing/mainoperation/mmcefa"
                component={AsyncMmcefa}
            />
            <Route
