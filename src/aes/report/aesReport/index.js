                            ...
                            <Table.Row>
                                ...
                                <Table.Cell width={1}>
                                    <DatePicker
                                        ...
                                        selected={
                                            btFrom ? moment(btFrom) : null
                                        }
                                        locale="ru"
                                        onChange={v =>
                                            this.handleInputChange(v, 'btFrom')
                                        }
                                    />
                                </Table.Cell>
                                <Table.Cell width={1}>
                                ...
                                <Table.Cell width={1}>
                                    <DatePicker
                                        ...
                                        onChange={v =>
                                            this.handleInputChange(v, 'dateTo')
                                        }
                                    />
                                </Table.Cell>
                                <Table.Cell width={4}>
                                    {listAes.map((code, i) => (
                                        <strong key={i}>
                                            {code.country_id}-{code.dep_id}-
                                            {code.os_code}-{code.type1_code}-
                                            {code.type2_code}-{code.type3_code}-
                                            {code.detail_code}-{code.room_code}-
                                            {code.status_code}
                                            <br />
                                        </strong>
                                    ))}
