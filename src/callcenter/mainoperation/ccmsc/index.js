...
const Ccmsc = props => {
    ...
    const [blackListParam, setBlackListParam] = useState(emptyBlackListParam);
        ...
        props.postSmsrcusDeactivateClientFilter(
            ...
            () => {
                let deleteFilter = smsrcusClientList.filter(
                    item =>
                        item.contractnumber !== deleteModalData.contractNumber,
                );
    ...
    return (
        <Container fluid className="containerMargin">
            <Segment className="justifySegment">
                <h3>
                    Поиск клиентов {blackList === true ? '(Черный список)' : ''}
                </h3>
                ...
                <Form>
                    <Form.Group widths="equal">
                        ...
                        <Form.Field>
                            ...
                            <Input
                                value={
                                    param.customerFIO ? param.customerFIO : ''
                                }
                                ...
                                onChange={event =>
                                    setParam({
                                        ...param,
                                        customerFIO: event.target.value,
                                    })
                                }
                            />
                        </Form.Field>
                    ...
                    <Form.Group widths="equal">
                        <Form.Field>
                            ...
                            <Input
                                ...
                                onChange={event =>
                                    setParam({
                                        ...param,
                                        customerIinBin: event.target.value,
                                    })
                                }
                            />
                        </Form.Field>
                        <Form.Field>
                            ...
                            <Input
                                value={
                                    param.fullAddress ? param.fullAddress : ''
                                }
                                            ...
                                            ? filterSubRow[0].filter.map(
                                                  (item, index) => (
                                                      <Table.Row key={index}>
                                                          ...
                                                          <Table.Cell>
                                                              {
                                                                  item.crmCategoryName
                                                              }
                                                          </Table.Cell>
                                                          <Table.Cell>
                                                              {
                                                                  item.planOperatorFIO
                                                              }
                                                          </Table.Cell>
                                                          <Table.Cell>
                                                              {item.f1MtLeft}
...
export default connect(mapStateToProps, {})(injectIntl(Ccmsc));
