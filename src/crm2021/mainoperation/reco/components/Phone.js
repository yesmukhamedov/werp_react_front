...
class Phone extends Component {
            ...
            <div>
                <Form.Group widths="equal">
                    <Form.Field
                        ...
                        onChange={(e, o) =>
                            this.handleDemoForm('clientName', o)
                        }
                    ...
                    <Form.Field error={demoErrors.dateTime} required>
                        ...
                        <DatePicker
                            ...
                            locale={locale}
                            label=""
                            value={stringYYYYMMDDHHMMToMoment(
                            ...
                            selected={
                                demo.dateTime
                                    ? stringYYYYMMDDHHMMToMoment(demo.dateTime)
                                    : null
                            }
                            onChange={v =>
                                this.handleDemoForm(
            ...
            <Table celled striped>
                <Table.Body>
                    ...
                    <Table.Row>
                        <Table.Cell>
                            <Header as="h4">
                                {messages['Form.Reco.PhoneNumber']}
                            </Header>
                        </Table.Cell>
                        <Table.Cell>
    ...
    checkCallInfo(callInfo, timer) {
        if (!callInfo['success']) {
            ...
            callInfo['call'] &&
            callInfo['call']['answer_time'] != null
        ) {
