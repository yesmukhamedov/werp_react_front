...
const taskAdminUrl = `core/task-admins/all`;
//const usersUrl = `users?active=true`;

const createTaskAdminUrl = `core/task-admins`;
const removeTaskAdminUrl = `core/task-admins`;
    ...
    return dispatch => {
        req.then(() => {
            ...
            dispatch(
                notify(
                    'error',
                    `Task admin was not created! ${response}`,
                    'Ошибка',
                ),
            );
        });
    ...
    return dispatch => {
        req.then(() => {
            ...
            dispatch(
                notify(
                    'error',
                    `Task admin was not deleted! ${response}`,
                    'Ошибка',
                ),
            );
        });
