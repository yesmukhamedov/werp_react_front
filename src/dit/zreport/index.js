...
import ListReport from './lstReport';
...
function Zreport(props) {
  ...
  console.log('dynobj ', props.dynObjTrLst);
  return (
    <Container
      fluid
      style={{
    ...
    >
      <Segment clearing>
        ...
        {/*   
                ...
                <Modal size="large"  
                    open={zrForm.showModal} 
                >
                    <Modal.Header>{messages['BTN__ATTACH_FILE']}</Modal.Header>
                    <Modal.Content>
                        <NewZReport messages = {messages} />
                    </Modal.Content>
                    <Modal.Actions />
                </Modal>
                */}
...
export default connect(
  mapStateToProps,
  { fetchZreports, uploadZReport, deleteFile, updateZreport },
)(injectIntl(Zreport));
