...
const AddUser = props => {
  const { messages, countryCodeOptions = [], countryList = [] } = props;
  ...
  const submitForm = () => {
    ...
    const sysUser = Object.assign({}, state.sysUser);
    const radioCheck = Object.assign({}, state.radioCheck);
    sysUser['staff_id'] = props.selStaff.staff_id;
    ...
    if (errors === null || errors === undefined || errors.length === 0) {
      props.newUser(sysUser, successClear());
    }
  ...
  const inputChange = (fieldName, o) => {
    let sysUser = Object.assign({}, state.sysUser);

    let radioCheck = Object.assign({}, state.radioCheck);
    switch (fieldName) {
      case 'username':
      ...
      case 'bukrs':
        ...
        props.getBrByBukrSysUser(o.value);
        o.options.some(c => {
  ...
  return (
    <Form>
      <Form.Group widths="equal">
        ...
        <Form.Field required>
          ...
          <Dropdown
            ...
            onChange={(e, o) => inputChange('branch_id', o)}
          />
        </Form.Field>
        <Form.Field
          defaultValue={state.sysUser.internal_number}
          onChange={(e, o) => inputChange('internal_number', o)}
          control={Input}
      ...
      <Form.Group widths="equal">
        ...
        <Form.Field required>
          ...
          <Dropdown
            ...
            multiple
            options={props.roles}
            defaultValue={props.rids}
            onChange={(e, o) => inputChange('rids', o)}
          />
        </Form.Field>
      </Form.Group>
      ...
      <Form.Group>
        <Form.Field>
          ...
          <Form.Group>
            ...
            <MaskedInput
              value={
                state.sysUser.mobileNumber ? state.sysUser.mobileNumber : ''
              }
              mask={phoneMask(state.countryCode)}
              placeholder={
      ...
      <Form.Group widths="equal">
        <Form.Field
          required
          value={state.sysUser.username}
          onChange={(e, o) => inputChange('username', o)}
          control={Input}
        ...
        <Form.Field required>
          ...
          <Input
            ...
            onChange={(e, o) => inputChange('password', o)}
          />
          <Button color="teal" onClick={randomGenerate.bind(this)}>
            <Icon name="refresh" />
          </Button>
        </Form.Field>
      </Form.Group>
      <Form.Field>
        Selected value:<b>{String(state.radioCheck.checked)}</b>
      </Form.Field>
      <Form.Field>
        <Radio
          toggle
          label={messages['L__STATUS']}
          onChange={(e, o) => inputChange('active', o)}
          checked={state.radioCheck.checked}
        />
      </Form.Field>
      <Form.Field>
        Selected value:
        <b>
          {state.radioCheck.is_root
            ? messages['BTN__YES']
            : messages['BTN__NO']}
        </b>
      </Form.Field>
      <Form.Field>
        <Radio
          ...
          checked={state.radioCheck.is_root}
        />
      </Form.Field>
      <Button color="teal" onClick={submitForm.bind(this)} floated="right">
