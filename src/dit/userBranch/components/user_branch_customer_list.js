...
class UserBranchCustomerList extends Component {
  ...
  onCustomerF4Selct(customer) {
    ...
    if (this.state.idx === 'new') waUbc = Object.assign({}, this.props.newUbc);
      ...
      waUbc = Object.assign(
        {},
        this.props.userBranchCustomerList[this.state.idx],
      );
    ...
    if (this.state.idx === 'new') this.props.selectNewUbc(waUbc);
  ...
  addCustomer(event) {
    ...
    const waNewUbc = Object.assign({}, this.props.newUbc);
    ...
    if (this.props.newUbc.customerId) {
      ...
      const waUbc = Object.assign({}, this.props.newUbc);
      waUbc.fio = '';
      waUbc.iin_bin = null;
      waUbc.fiz_yur = 1;
            ...
            <Table.Row key={idx}>
              ...
              <Table.Cell>
                <Icon
                  ...
                  onClick={event => this.onCustomerF4ButtonClick(idx)}
                />
              </Table.Cell>
              ...
              <Table.Cell>
                <Dropdown
                  ...
                  options={options}
                  value={ubc.ubcAccess}
                  onChange={(e, { value }) => this.changeAccess(idx, value)}
                />
              </Table.Cell>
              <Table.Cell>
                <Icon
                  ...
                  className="clickableIcon"
                  color="red"
                  onClick={event => this.removeCustomer(event, idx)}
                />
              </Table.Cell>
            </Table.Row>
          );
        ...
        <Table.Row>
          ...
          <Table.Cell>
            <Icon
              ...
              size="large"
              className="clickableIcon"
              onClick={event => this.onCustomerF4ButtonClick('new')}
            />
          </Table.Cell>
          ...
          <Table.Cell>
            <Icon
              ...
              className="clickableIcon"
              color="green"
              onClick={event => this.addCustomer(event)}
            />
          </Table.Cell>
        </Table.Row>
      );
    ...
    return (
      <div id="bukrsBranchDiv">
        <CustomerF4
          ...
          onCloseCustomerF4={open => this.setState({ open })}
          onCustomerSelect={customer => this.onCustomerF4Selct(customer)}
        />
        <div>
          <Button
            icon
            ...
            size="small"
            onClick={() =>
              this.props.saveUserBranchCustomers(
                this.props.userBranchCustomerList,
              )
            }
          >
