import {
    ...
    EDIT_USER_BRANCHES,
    ERROR,
    FETCH_USER_BRANCH_CUSTOMERS,
    ADD_UBC,
    CHANGE_UBC,
    REMOVE_UBC,
    CHANGE_ACCESS_UBC,
    SAVE_USER_BRANCH_CUSTOMERS,
    ...
    switch (action.type) {
        case FETCH_USERS:
            return {
                ...
                foundUsers: action.payload.data,
            };
        case FIND_USERS:
            return {
                ...state,
        ...
        case FETCH_USER_BRANCHES:
            return {
                ...state,
                userBranchList: action.payload.data,
                userBranchCustomerList: [],
            };
        case EDIT_USER_BRANCHES:
            return { ...state, userBranchList: action.payload.data };
        case MARK_BRANCH:
            const waUserBranchList = JSON.parse(
                JSON.stringify(state.userBranchList),
            );
            index = action.payload;
            waUserBranchList[index].flagExists = !state.userBranchList[index]
                .flagExists;
        ...
        case REMOVE_UBC:
            wa_userBranchCustomerList = JSON.parse(
                JSON.stringify(state.userBranchCustomerList),
            );
            index = action.payload;
            wa_userBranchCustomerList[index].remove = !state
                .userBranchCustomerList[index].remove;
            return {
                ...state,
                userBranchCustomerList: wa_userBranchCustomerList,
            };
