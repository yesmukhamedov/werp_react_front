...
import { Dimmer, Form, Grid, Label, Loader, Search, Segment } from 'semantic-ui-react';
...
class MessageGroupUserSearchDisplay extends Component {
  ...
  handleSearch(values) {
    ...
    const params = _.map(
      ...
      .join('&');
    // console.log(params)
    return new Promise(resolve => this.props.fetchMessageGroupUsers(params, resolve));
  }
  ...
  handleResultSelect = (e, { result }) => this.setState({ value: result.title, userId: result.key })
        ...
        <Form onSubmit={handleSubmit(this.handleSearch)}>
            <Form.Group widths="equal">
                ...
                <Form.Group widths="equal">
                    ...
                    disabled={submitting}
                    style={
                        { marginTop: '1.7em', background: 'rgba(84,170,169, 1)', color: 'white' }}
                    />
                    {/* <Form.Button
